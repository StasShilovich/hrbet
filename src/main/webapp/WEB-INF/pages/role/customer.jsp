...
<button type="button" class="btn header-item waves-effect">
    <a class="text-reset notification-item"
       href="${pageContext.request.contextPath}/dispatcher?command=add_race">
        <span class="noti-dot"><fmt:message key="label.addRace"/></span>
    </a>
</button>
<!--enterResult-->
<button type="button" class="btn header-item waves-effect">
    <a class="text-reset notification-item"
       href="${pageContext.request.contextPath}/dispatcher?command=logout">
        <span class="noti-dot"><fmt:message key="label.enterResult"/></span>
    </a>
</button>
<!--profile-->
<button type="button" class="btn header-item waves-effect">
